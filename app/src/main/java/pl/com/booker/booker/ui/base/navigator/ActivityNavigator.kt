package pl.com.booker.booker.ui.base.navigator
...
import pl.com.booker.booker.ui.base.navigator.Navigator
...
open class ActivityNavigator(protected val activity: FragmentActivity) : Navigator {
    ...
    override fun startActivityForResult(
            activityClass: Class<out Activity>, setArgsAction: (Intent) -> Unit,
            requestCode: Int
    ) {
    ...
    override fun startActivityForResult(activityClass: Class<out Activity>, arg: Parcelable, requestCode: Int) {
        startActivityInternal(
                activityClass,
                { intent -> intent.putExtra(Navigator.EXTRA_ARG, arg) },
                requestCode
        )
    }
    ...
    override fun replaceFragmentAndAddToBackStack(
            @IdRes containerId: Int, fragment: Fragment, args: Bundle,
            backstackTag: String
    ) {
    ...
    override fun replaceFragmentAndAddToBackStack(
            @IdRes containerId: Int, fragment: Fragment, fragmentTag: String,
    ...
    protected fun replaceFragmentInternal(
            fm: FragmentManager, @IdRes containerId: Int, fragment: Fragment,
            fragmentTag: String?, args: Bundle?, addToBackstack: Boolean,
            backstackTag: String?
    ) {
        if (args != null) {
